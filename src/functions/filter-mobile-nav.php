...
function utkchancellor_mobileButton($menu) {
  ?>
    <button class="btn btn-primary d-lg-none align-self-end" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsive" aria-controls="offcanvasResponsive" aria-label="Toggle Navigation">
